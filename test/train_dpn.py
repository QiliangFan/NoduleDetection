...
def main():
    for fold in range(10):
        ...
        model_ckpt = ModelCheckpoint(dirpath=ckpt_path, monitor="precision", verbose=True)
        ...
        trainer = Trainer(gpus=[1], callbacks=[model_ckpt], max_epochs=20, resume_from_checkpoint=ckpt)
